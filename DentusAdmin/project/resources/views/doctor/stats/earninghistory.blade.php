                      ...
                      <div class="row align-items-center">
                         <div class="col">
                            <div class="doctor-table-blk">
                               <h3 class="me-2">Earning History</h3>
                               <div class="doctor-search-blk">
                                  <div class="add-group1">
                                     {{-- <a href="{{ route('admin.appoint.vgraph') }}" class="btn btn-success">View Graph</a> --}}
                                  </div>
                               </div>
                            </div>
                         </div>
                   ...
                   <div class="staff-search-table">
                      <form method="GET" action="{{ route('admin.appoint.earninghistory') }}">
                         <div class="row">
                            ...
                            <div class="add-group">
                              <a href="{{ route('admin.appoint.earninghistory') }}" class="btn btn-primary doctor-refresh ms-2"><img src="{{asset('content/admin')}}/img/icons/re-fresh.svg" alt></a>
                           </div>
                         </div>
                      </form>
                   </div>
                   ...
                   <div class="table-responsive">
                      <table class="table border-0 custom-table comman-table datatable mb-0">
                         ...
                         <tbody>
                            ...
                            <tr>
                               <td>#{{$a['id']}}</td>
                               <td>{{$a['created_attime']}}</td>
                               <td>Consultation with {{$a['user_name']}}</td>
                               <td><span class="badge badge-soft-success">&#8377; {{$a['total_amount']}}</span></td>
                            </tr>
                            @endforeach
                            @endif
