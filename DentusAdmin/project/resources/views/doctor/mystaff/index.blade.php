                        ...
                        <div class="col">
                           <div class="doctor-table-blk">
                              ...
                              <div class="doctor-search-blk">
                                 <div class="add-group">
                                    <a href="{{ route('admin.user.mystaff') }}" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('adminassets') }}/img/icons/re-fresh.svg" alt></a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="table-responsive">
                     <table class="table border-0 custom-table comman-table datatable mb-0">
                        ...
                        <tbody>
                           ...
                           @endphp
                           <tr>
                              <td class="profile-image"><a href="{{ route('admin.user.mystaffdetail',$a->id) }}"><img width="28" height="28" src="{{asset('../content/doctor/'.$a->image)}}" class="rounded-circle m-r-5" alt> Dr. {{$a->name}} {{$a->last_name ?? ''}}</a></td>
                              @if($a->parent_id == 0)
                              ...
                              <td>{{ implode(', ', $specialisations_data) }}</td>
                              <td>
                                 @if ($a->approved == 3)
