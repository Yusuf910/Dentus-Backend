                  ...
                  <div class="row">
                     	...
                     	<div id="new_user_form">
						   ...
						   <div class="col-12 col-md-6 col-xl-6">
						      <div class="input-block local-forms">
						         ...
						         <input type="date" max="{{ date('Y-m-d') }}" class="form-control" id="dob" name="date_of_birth">
						      </div>
						   </div>
						   <div class="col-12 col-md-6 col-xl-6">
						      <div class="input-block local-forms">
                     ...
                     <div class="col-12 col-md-6 col-xl-6">
                        <div class="input-block local-forms">
                           ...
                           <select name="treatment_id" required class="form-control select">
                     ...
                     <div class="col-12 col-md-12 col-xl-12">
                        <div class="input-block local-forms">
                           ...
                           <select name="clinic_id" class="form-control select">
                     ...
                     <div class="col-12 col-md-6 col-xl-6">
                        <div class="input-block local-forms">
                           ...
                           <input name="symptoms" class="form-control" type="text">
                        </div>
                     </div>
                     <div class="col-12 col-md-6 col-xl-6">
                        <div class="input-block local-forms">
                     ...
                     <div class="col-12 col-md-6 col-xl-6">
                        <div class="input-block local-forms cal-icon">
                           ...
                           <input name="schedule_date" class="form-control" id="your_datepicker_input" type="text">
                        </div>
                     </div>
                     <div class="col-12 col-md-6 col-xl-6">
                        <div class="input-block local-forms">
                           <label>Select Time</label>
                           <select id="conSlots" name="start_time" class="form-control">
	        ...
	        $.post(apiurl, { dateselect: dateselect, _token: "{{ csrf_token() }}", id: selectid, type: what }, function (response) {
	            if (response.status && response.dateslots.length > 0) {
	                ...
	                $.each(slots, function (index, slot) {
	                    ...
	                    let isBooked = slot.is_book === 1 ? 'disabled' : ''; // Disable booked slots
	                    slotHtml += `<option value="${timeRange}" ${isBooked}>${timeRange}</option>`;
	                });
