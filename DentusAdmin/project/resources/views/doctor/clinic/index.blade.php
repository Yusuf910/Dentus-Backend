                           ...
                           <tr>
                              ...
                              <td>
                                 <ul>
                                    ...
                                    <li>
                                       Image  <a href="{{route('admin.master.clinicimages',$a->id)}}" type="button" class="btn btn-primary" ><i class="fas fa-eye"></i></a>
                                    </li>
                                    <li>
                                       Timing  <a href="{{route('admin.master.clinictiming',$a->id)}}" type="button" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                                    </li>
                                    <li>
                                       Holiday  <a href="{{route('admin.master.clinicholiday',$a->id)}}"  type="button" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                                    </li>
                                 </ul>
                              </td>
                              <td>
