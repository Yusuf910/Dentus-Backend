                        ...
                        <div class="login-right">
                           <div class="login-right-wrap">
                              <div class="account-logo">
                                 <a href="index.html"><img src="{{asset('content/admin')}}/img/login-logo.svg" alt></a>
                              </div>
                              <h2>Login</h2>
                              <form action="{{ route('admin.check') }}" method="post">
                                ...
                                @csrf
                                 ...
                                 <div class="input-block">
                                    ...
                                    <input required class="form-control pass-input" type="password" value="{{ old('password') }}" name="password">
