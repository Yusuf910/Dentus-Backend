                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input required class="form-control" type="text" id="role_name" placeholder="Enter name" name="name">
                              </div>
                           </div>
                           <div class="form-group row">
                              <label for="example-text-input" class="col-sm-2 col-form-label">comments<span class="text-danger">*</span></label>
                              <div class="col-sm-10">
                                 <input required name="comments" min="1" class="form-control" type="text" id="example-text-input" placeholder="eg. 1">
                              </div>
                           </div>
                           <div class="form-group row">
                              <label for="example-text-input" class="col-sm-2 col-form-label">rating<span class="text-danger">*</span></label>
                              <div class="col-sm-10">
                                 <input required name="rating" min="1" max="5" class="form-control" type="number" id="example-text-input" placeholder="eg. 1">
                              </div>
                           </div>
