                     ...
                     <div class="row">
                        ...
                        {{-- <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                            <select class="form-control bundle_search" name="user_id">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               <input required class="form-control" type="text" placeholder="Enter Offer Type" name="offer_type" value="{{ $a->offer_type }}">
                            </div>
                         </div>
                         ...
                         <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               <input required class="form-control" type="text" placeholder="Enter discount" name="discount" value="{{ $a->discount }}">
                            </div>
                         </div>
                         ...
                         <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               <input required class="form-control" type="date" placeholder="Enter Date" name="start_date" value="{{ $a->start_date }}">
                            </div>
                         </div>
                         ...
                         <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               <input required class="form-control" type="date" placeholder="Enter Date" name="end_date" value="{{ $a->end_date }}">
                            </div>
                         </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               <img height="100" width="100" src="{{ asset('content/SeasonalOffers') }}/{{$a->image}}" alt="">
                            </div>
                         </div>
                         <div class="form-group row">
                            <label for="example-text-image" class="col-sm-2 col-form-label">Image <span class="text-danger">*</span></label>
