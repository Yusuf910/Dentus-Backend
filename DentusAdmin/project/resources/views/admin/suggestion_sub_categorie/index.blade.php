                     ...
                     <table id="datatable" class="table table-bordered table-striped dt-responsive  nowrap w-100 table-sm">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{  $dt->name }}</td>
                              <td>{{ $a->name }}</td>
                              <td><img height="100" width="100" src="{{ asset('content/suggestion') }}/{{$a->image}}" alt=""></td>
                              <td>
                                 @if($a->status == 1)
               ...
               <div class="modal-body">
                   ...
                   <div class="col-md-12">
                       ...
                       <div class="col-md-12">
                           ...
                           <input required class="form-control" type="file" id="example-text-input" placeholder="name" name="image">
                           </div>
                       </div>
