                     ...
                     <div class="row">
                        <div class="col-12">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <textarea id="ckeditor-classic" rows="5" class="form-control" placeholder="description" spellcheck="false" name="description"><?=$a->description?></textarea>
                              </div>
                           </div>
                           <div class="form-group row">
                              <label for="example-text-input" class="col-sm-2 col-form-label">Published Date to show <span class="text-danger">*</span></label>
                              <div class="col-sm-10">
                                 <input required value="{{ $a->published_date }}" class="form-control" type="date" id="example-text-input" placeholder="Enter published_date" name="published_date">
                              </div>
                           </div>
                           <div class="form-group row">
                           ...
                           <div class="form-group row">
                              <label for="example-text-image" class="col-sm-2 col-form-label">Image <span class="text-danger">*</span></label>
                              <div class="col-sm-10">
                                 <input  class="form-control" type="file" id="example-text-image" placeholder="Enter image" name="image">
                              </div>
                           </div>
