               ...
               <div class="modal-body">
                   <div class="row">
                       <div class="col-md-12">
                           ...
                           <input required class="form-control" type="text" id="example-text-input" placeholder="Title" name="title">
                           </div>
                       </div> 
                       <div class="col-md-12">
                           <div class="mb-3">
                               ...
                               <textarea 
                               rows="5" class="form-control" placeholder="answer" spellcheck="false" name="description"></textarea>
                           </div>
                       </div> 
                       <div class="col-md-12">
                               <div class="mb-3">
