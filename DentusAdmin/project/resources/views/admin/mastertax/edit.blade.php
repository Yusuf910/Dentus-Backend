                     ...
                     <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               <input required class="form-control" type="text" placeholder="Enter Name" name="taxvalue" value="{{ $a->taxvalue }}">
                            </div>
                         </div>
                        ...
                        {{-- <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <input name="position" min="1" class="form-control" type="number" value="{{ $a->position }}" placeholder>
                           </div>
                        </div> --}}
                        <div class="col-12 col-md-6 col-xl-6">
