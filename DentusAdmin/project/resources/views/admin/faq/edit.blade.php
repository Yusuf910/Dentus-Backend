                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input required value="{{ $a->title }}" class="form-control" type="text" id="example-text-input" placeholder="Enter Question" name="question">
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <textarea id="" rows="5" class="form-control" placeholder="answer" spellcheck="false" name="answer"><?=$a->description?></textarea>
                              </div>
                           </div>
                           <div class="form-group row">
