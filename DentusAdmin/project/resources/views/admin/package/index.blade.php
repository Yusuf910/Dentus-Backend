                           ...
                           <div class="doctor-table-blk">
                              ...
                              <div class="doctor-search-blk">
                                ...
                                <div class="add-group">
                                   ...
                                   <a href="{{ route('admin.package.packagelist') }}" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('adminassets') }}/assets/img/icons/re-fresh.svg" alt></a>
                                </div>
                             </div>
                           </div>
                        </div>
                     ...
                     <table class="table border-0 custom-table comman-table datatable mb-0">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="profile-image"><a href="#">{{ $a->price ?? ""}}</a></td>
                              <td>{{ $a->discount_price ?? ""}}</td>
                              <td>{{ $tx->name ?? ""}}</td>
                              <td>
