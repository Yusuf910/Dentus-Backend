   ...
   <div class="content">
      <div class="page-header">
         <div class="row">
            <div class="col-sm-12">
               <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Subscription </a></li>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <input required class="form-control" type="text"  placeholder="Enter price" name="price" value="{{ $a->price }}">
                           </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              <label>Discount Price<span class="login-danger">*</span></label>
                              <input name="discount_price" min="1" class="form-control" type="number" placeholder value="{{ $a->discount_price }}">
                           </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="input-block local-forms">
                               ...
                               {{-- <input name="tax_id" min="1" class="form-control" type="number" placeholder value="{{ $a->tax_id }}"> --}}
