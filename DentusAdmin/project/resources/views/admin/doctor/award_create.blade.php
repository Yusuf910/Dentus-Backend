...
<div class="page-wrapper">
    ...
    <div class="card-body pt-4">
        <form method="POST" action="{{ route('admin.award_store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
    <div class="row">
        @if ($errors->any())
    ...
    <input class="form-control" type="text" name="awards_name">
    </div>
    </div>
    ...
    <div class="input-block local-forms">
    <label>Year</label>
    <input class="form-control" type="text" name="award_year">
