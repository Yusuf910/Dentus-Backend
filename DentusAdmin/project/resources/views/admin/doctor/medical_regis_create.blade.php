...
<div class="page-wrapper">
    ...
    <div class="card-body pt-4">
        <form method="POST" action="{{ route('admin.medical_regis_store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
    <div class="row">
    ...
    <select name="registration_council" class="form-control select" required>
        ...
        <?php $registration_council = DB::table('master_registraion_councils')->where('status', 1)->get(); ?>
        @if(isset($registration_council) && count($registration_council) > 0)
            @foreach ($registration_council as $p)
    ...
    <input class="form-control" type="text" name="registration_year">
