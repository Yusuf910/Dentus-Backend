...
<div class="page-wrapper">
    ...
    <select name="degree" class="form-control select" required>
        ...
        @if(isset($degrees) && count($degrees) > 0)
            @foreach ($degrees as $p)
                <option value="{{ $p->id }}" {{ $p->id == $a->degree ? 'selected' : '' }}>
    ...
    <select name="college_institute" class="form-control select" required>
        ...
        @if(isset($college_institute) && count($college_institute) > 0)
            @foreach ($college_institute as $p)
                <option value="{{ $p->id }}" {{ $p->id == $a->college_institute ? 'selected' : '' }}>
                    {{ htmlspecialchars($p->name, ENT_QUOTES, 'UTF-8') }}
                </option>
            @endforeach
        @endif
    ...
    <input class="form-control" type="text" name="year_of_completion" value="{{ $a->year_of_completion }}">
    </div>
    </div>
    ...
    <input class="form-control" type="text" name="year_of_experience" value="{{ $a->year_of_experience }}">
