...
<div class="page-wrapper">
    ...
    <input class="form-control" type="text" name="awards_name" value="{{ $a->awards_name}}">
    </div>
    </div>
    ...
    <select name="award_college_institute" class="form-control select" required>
        ...
        @if(isset($college_institute) && count($college_institute) > 0)
            @foreach ($college_institute as $p)
                <option value="{{ $p->id }}" {{ $p->id == $a->award_college_institute ? 'selected' : '' }}>
    ...
    <div class="input-block local-forms">
    <label>Year</label>
    <input class="form-control" type="text" name="award_year" value="{{ $a->award_year}}">
