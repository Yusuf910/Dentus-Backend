...
<div class="page-wrapper">
    ...
    <div class="card-body pt-4">
        ...
        <div class="row">
            ...
            @php
                // Decode the existing doctor availability
                $schedule = json_decode($a->doctor_availability, true)['schedule'] ?? [];
            @endphp
            ...
            @foreach (['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'] as $day)
                ...
                <div class="col-12 col-md-4 col-xl-4">
                    <div class="input-block local-forms">
                        ...
                        <input class="form-control" type="time" name="schedule[{{ strtolower($day) }}][start]"
                               value="{{ isset($schedule[strtolower($day)]) ? $schedule[strtolower($day)]['start'] : '' }}" required>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-xl-4">
                    <div class="input-block local-forms">
                        <label>End Time<span class="login-danger">*</span></label>
                        <input class="form-control" type="time" name="schedule[{{ strtolower($day) }}][end]"
                               value="{{ isset($schedule[strtolower($day)]) ? $schedule[strtolower($day)]['end'] : '' }}" required>
                    </div>
                </div>
            @endforeach
