                     ...
                     <table id="datatable" class="table table-bordered table-striped dt-responsive  nowrap w-100 table-sm">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 @if($a->for_new_user == 1)
                                 <span class="btn btn-primary btn-sm">Yes</span>
                                 @else
                              ...
                              <?php $coupan = DB::table('coupan')->where('id',$a->coupon)->first();?>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-12">
                           <div class="mb-3">
                               ...
                               <input required class="form-control" type="number" min="1" id="recharge_amount" placeholder="Coupon recharge_amount" name="recharge_amount">
                           </div>
                       </div>
                       <div class="col-md-12">
                           <div class="mb-3">
                               <label for="coupan_id" class="form-label">Coupon</label>
                               <select class="form-select" name="coupan_id">
                                  <option value="0">Please Select</option>
                                  @if($getcoupan->count() > 0)
                                  @foreach($getcoupan as $get)
                                  <option value="{{$get->id}}">{{$get->code}}</option>
                                  @endforeach
                                  @endif
                       ...
                       <div class="col-md-12">
                           <div class="mb-3">
                               <label for="is_for_new_user" class="form-label">Is for new user ?</label>
                               <select class="form-select" name="for_new_user" required>
