   ...
   <div class="content">
      <div class="page-header">
         <div class="row">
            <div class="col-sm-12">
               <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Blog </a></li>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <input required class="form-control" value="{{ $a->name }}" type="text" placeholder="Enter title" name="name">
                           </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-12">
                           <div class="input-block summer-mail">
                              <textarea rows="4" cols="5" id="content" name="description" class="form-control summernote" placeholder="Enter your message here"><?=$a->description?></textarea>
                           </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-image" class="col-sm-2 col-form-label">Image <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                               <img height="100" width="100" src="{{ asset('content/blogs') }}/{{$a->image}}" alt="">
                            </div>
                         </div>
                         <div class="form-group row">
                            <label for="example-text-image" class="col-sm-2 col-form-label">Image <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <input required class="form-control" type="text"  placeholder="Enter link" name="video_link" value="{{ $a->video_link }}">
                           </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              <label>Set Position <span class="login-danger">*</span></label>
                              <input name="position" min="1" class="form-control" type="number" placeholder value="{{ $a->position }}">
                           </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-6">
