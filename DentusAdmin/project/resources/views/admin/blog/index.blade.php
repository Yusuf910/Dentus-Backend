                           ...
                           <div class="doctor-table-blk">
                              ...
                              <div class="doctor-search-blk">
                                ...
                                <div class="add-group">
                                   ...
                                   <a href="{{ route('admin.master.blog') }}" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('adminassets') }}/assets/img/icons/re-fresh.svg" alt></a>
                                </div>
                             </div>
                           </div>
                        </div>
                     ...
                     <table class="table border-0 custom-table comman-table datatable mb-0">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="profile-image"><a href="#">{{ $dr->name ?? ""}}</a></td>
                              <td class="profile-image"><a href="#">{{ $a->name ?? ""}}</a></td>
                              <td>{{ $a->description ?? ""}}</td>
                              {{-- <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#centermodal"><i class="fas fa-eye"></i></button></td> --}}
                              <td>{{ $a->type == 'blog' ? 'Blog' : ($a->type == 'video' ? 'Video' : '') }}</td>
                              <td>{{ $a->video_link ?? ""}}</td>
                              <td><img width="50" height="50" src="{{ asset('../content/blogs/') }}/{{$a->image ?? "" }}" class="m-r-5" alt></td>
                              <td>{{ $a->position ?? ""}}</td>
                              <td>
