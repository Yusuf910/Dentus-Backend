                     ...
                     <table id="datatable" class="table table-bordered table-striped dt-responsive  nowrap w-100 table-sm">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 @if($a->type == 1)
                                 <span class="btn btn-sm">Booking</span>
                                 @else
                                 <span class="btn btn-sm">Ask a question</span>
                                 @endif
                              </td>
                              <td>
                                 @if($a->status == 1)
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-12">
                           <div class="mb-3">
                               ...
                               <textarea id="ckeditor-classic" rows="5" class="form-control" placeholder="answer" spellcheck="false" name="answer"></textarea>
                           </div>
                       </div> 
                       <div class="col-md-12">
                               <div class="mb-3">
