         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="text-center mb-5">
                     ...
                     <h4 class="text-uppercase">Unauthorize access</h4>
                     <div class="mt-5 text-center">
                        <a class="btn btn-primary waves-effect waves-light" href="{{ route('admin.home') }}">Back to Dashboard</a>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row justify-content-center">
               <div class="col-md-10 col-xl-8">
                  <div>
                     <img src="{{ asset('adminassets') }}/images/error-img.png" alt="" class="img-fluid">
                  </div>
               </div>
               <!-- end row -->
            </div>
