    ...
    //    print_r( $request);die();
        if ($request->exp == 'export') {
            ...
            $data[] = array(
                ...
                "PG Astro","TDS Astro ","Astrologer Comission Amount","Total Astro Comission","start_time","end_time","Added_on","Cancel_by","total_seconds","Booking Tries","Booking Tries Time","Cancelled time"
            );
