      ...
      <div class="row">
         <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4 class="mb-sm-0 font-size-18">Edit Coach</h4>
   ...
   <div class="col-md-12">
      <div class="mb-3">
         ...
         <input class="form-control" name="email" value="{{ $a->email }}" 
            pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-zA-Z]{2,4}" type="email">
      </div>
   </div>
   ...
   <div class="col-md-12">
      <div class="mb-3">
         ...
         <input type="number" name="mobile" tag="number" class="form-control" 
            value="{{ $a->mobile }}" placeholder="Mobile Number" min="1" maxlength="15" 
            onkeypress="return onlyNumberKey(event)" pattern="[789][0-9]{9}"
