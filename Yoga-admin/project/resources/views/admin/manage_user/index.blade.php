               ...
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                     <div class="d-flex flex-wrap gap-2">
                        <a href="{{route('admin.create_user_list')}}" class="btn btn-primary waves-effect waves-light"><i class="bx bxs-add-to-queue font-size-16 align-middle me-2"></i> Add User
                        </a>
                  ...
                  <div class="card-body p-3">
                     <form class="form" action="" method="GET">
                        ...
                        <div>
                           ...
                           <a href="{{ route('admin.user_list') }}" class="btn btn-outline-primary w-md">Reset</a>
                        </div>
                     </form>
                  </div>
               </div>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 @endif --}}
                                <a href="{{ route('admin.edit_user_list', $a['_id'] ?? '') }}" 
                                class="btn btn-warning btn-sm waves-effect waves-light">
                                    <i class="mdi mdi-pencil d-block font-size-12"></i>
                                </a>

                                 <a href="{{ route('admin.user_details', $a->id) }}" class="btn btn-secondary btn-sm waves-effect waves-light">
   ...
   <div class="modal-dialog">
      <div class="modal-content bg-danger">
         ...
         <div class="modal-footer">
            <form method="POST" action="{{route('admin.delete_user_list')}}" enctype="multipart/form-data">
               @csrf
