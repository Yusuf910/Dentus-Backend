                                             ...
                                             <td valign="top" align="left">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="left" style="font-family:'Roboto',Arial;text-align:left;font-size:14px;color:#666666;line-height:20px">Your online support added:</td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
                                                      ...
                                                      <td valign="top" align="left">
                                                         <table style="width:100%; border-collapse: collapse; border: 1px solid #000;" border="1">
                                                            <tr align="left" style="background-color: #333; color: #fff;">
                                                               ...
                                                               <th style="font-size: 14px; text-align: center;">Voucher Code</th>
                                                               <th style="font-size: 14px; text-align: center;">Online Support(Expiry Date)</th>
                                                               <th style="font-size: 14px; text-align: center;">Activate Date</th>
                                                            </tr>
                                                            <?php $total_amount = 0;
                                                            	  $discountamount = 0;
                                                            ...
                                                            @if($bb)
                                                            <?php $getvoucher = App\Models\BookVoucher::find($a->voucher_code_id); ?>
                                                            <?php if ($getvoucher): ?>
                                                            	<tr>
	                                                               <td>
	                                                                  <strong>{{$i}}</strong>
	                                                               ...
	                                                               <td style="text-align: center;">{{$getvoucher->voucher}}</td>
	                                                               <td style="text-align: center;">{{$a->expiry_date}}</td>
	                                                               <td style="text-align: center;">{{date('Y-m-d',strtotime($a->created_at))}}</td>
	                                                            </tr>
                                                            <?php endif ?>
	                                                        <?php $i++; ?>
