                     ...
                     <div class="loginbox">
                        <div class="login-right">
                           <div class="login-right-wrap">
                              ...
                              <form action="{{ route('admin.otpverifyforget') }}" method="get">
                                 @if (Session::get('fail'))
                              ...
                              <div class="text-center">
                                 <p class="mt-15 mb-0">I did not recieve a code? <a href="{{ route('admin.resendotpforforget',$token) }}" class="text-warning ml-5"><strong>RESEND</strong></a></p>
                              </div>
                           </div>
                        </div>
                     </div>
