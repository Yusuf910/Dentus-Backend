                     ...
                     <div class="row">
                        ...
                        <div class="col-md-7">
                           <ul class="personal-info">
                              ...
                              <li>
                                 <span class="title">Expirence:</span>
         ...
         <div class="tab-content">
                  ...
                  <div class="col-md-12">
                     <div class="card-box">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                           ...
                           {{--@if(auth()->user()->id == $a->id)--}}<div class="flex-shrink-1"><a href="#" data-bs-toggle="modal" data-bs-target="#centermodal" class="btn btn-primary">Edit</a></div>{{--@endif--}}
                        </div>
                  ...
                  <div class="col-md-12">
                     <div class="card-box">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                           ...
                           {{--@if(auth()->user()->id == $a->id)--}}<div class="flex-shrink-1"><a href="#" data-bs-toggle="modal" data-bs-target="#centermodal2" class="btn btn-primary">Edit</a></div>{{--@endif--}}
                        </div>
                        <div class="row">
                           <div class="col-md-4">
                  ...
                  <div class="col-md-12">
                     <div class="card-box">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                           ...
                           {{--@if(auth()->user()->id == $a->id)--}}<div class="flex-shrink-1"><a href="#" data-bs-toggle="modal" data-bs-target="#centermodal3" class="btn btn-primary">Edit</a></div>{{--@endif--}}
                        </div>
                  ...
                  <div class="col-md-12">
                     <div class="card-box">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                           ...
                           {{--@if(auth()->user()->id == $a->id)--}}<div class="flex-shrink-1"><a href="#" data-bs-toggle="modal" data-bs-target="#centermodal4" class="btn btn-primary">Edit</a></div>{{--@endif--}}
                        </div>
                        <div class="experience-box">
                           <ul class="experience-list">
                              <li>
                  ...
                  <div class="col-md-12">
                     <div class="card-box">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                           ...
                           {{--@if(auth()->user()->id == $a->id)--}}<div class="flex-shrink-1"><a href="#" data-bs-toggle="modal" data-bs-target="#centermodal5" class="btn btn-primary">Edit</a></div>{{--@endif--}}
                        </div>
                        <ul class="personal-info">
                           <li>
            ...
            <div class="tab-pane" id="bottom-tab6">
               <div class="row">
                  <div class="col-md-12">
                     <div class="card-box">
                        @if(isset($r) && $r->count() > 0)
                        @foreach($r as $aa)
                           @if(
                               optional($aa->UserClinicDetails)->clinic_name &&
                               optional($aa->UserClinicDetails)->status == 1 &&
                               optional($aa->UserClinicDetails)->user_id ==
                                   (
                                       auth()->user()->parent_id > 0
                                           ? auth()->user()->parent_id
                                           : (auth()->user()->id == $a->id
                                               ? $a->id
                                               : $a->parent_id
                           ...
                           <?php if ($aa->UserClinicDetails->clinic_name == 'KMC') {
                                  
                               } ?>
                           <div class="d-flex justify-content-center align-items-center mb-3">
                           <div class="w-100">
                              <h3 class="card-title mb-0">Timings for {{$aa->UserClinicDetails->clinic_name}}</h3>
                           </div>
                           <div class="flex-shrink-1"><a data-bs-toggle="modal" data-bs-target="#centermodal6_{{ $aa->id }}" class="btn btn-primary">Edit</a></div>
                           </div>
                           <div class="experience-box">
                              <ul class="experience-list">
                                 @if(!is_null($aa->doctor_availability))
                                 <?php $t = json_decode($aa->doctor_availability, true); ?>
                                    @if($t > 0)
                           ...
                           <div class="modal fade" id="centermodal6_{{ $aa->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                               <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    @php
                                      $availability = json_decode($aa->doctor_availability, true) ?? [];

                                  @endphp
                                     <form method="POST" action="{{ route('admin.user.timingupdate2',$aa->id) }}" enctype="multipart/form-data">
                                       {{ csrf_field() }}
                                       <div class="row">
                                          <div class="col-md-12">
                                               ...
                                               <div class="mb-3">
                                                  ...
                                                  <div class="d-flex">
                                                    @php
                                                        ...
                                                        $morningStart = (!empty($morning[0]) && strtotime($morning[0]))
                                                            ? date('H:i', strtotime($morning[0]))
                                                            : '';

                                                        $morningEnd = (!empty($morning[1]) && strtotime($morning[1]))
                                                            ? date('H:i', strtotime($morning[1]))
                                                            : '';
                                                    @endphp
                                                ...
                                                <div class="d-flex">
                                                    @php
                                                        ...
                                                        $eveningStart = (!empty($evening[0]) && strtotime($evening[0]))
                                                            ? date('H:i', strtotime($evening[0]))
                                                            : '';

                                                        $eveningEnd = (!empty($evening[1]) && strtotime($evening[1]))
                                                            ? date('H:i', strtotime($evening[1]))
                                                            : '';
                                                    @endphp
                        ...
                        @endforeach
                        @else
                           @if(isset($getclininc) && $getclininc->count() > 0)
                              @foreach($getclininc as $aa)
                              <div class="d-flex justify-content-center align-items-center mb-3">
                              <div class="w-100">
                                 <h3 class="card-title mb-0">Timings for {{$aa->clinic_name}}</h3>
                              </div>
                              <div class="flex-shrink-1"><a data-bs-toggle="modal" data-bs-target="#centermodal6_{{ $aa->id }}" class="btn btn-primary">Edit</a></div>
                              </div>
                              <div class="experience-box">
                              ...
                              <div class="modal fade" id="centermodal6_{{ $aa->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                               <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                     ...
                                     @endphp
                                        <form method="POST" action="{{ route('admin.user.timingupdate3',$aa->id) }}" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                          <div class="row">
                                             <div class="col-md-12">
                                                  @foreach(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
