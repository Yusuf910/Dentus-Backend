                        ...
                        <div class="login-right">
                           <div class="login-right-wrap">
                              <div class="account-logo">
                                 <a href="{{ route('admin.signup') }}"><img src="{{asset('content/admin')}}/img/login-logo.svg" alt></a>
                              </div>
                              <h2>Register</h2>
                              @include('includes.admin.form-success') 
                              <form action="{{ route('admin.check2') }}" method="post">
                                 @if (Session::get('fail'))
                                ...
                                @csrf
                                 <div class="input-block">
                                    ...
                                    <input required class="form-control" type="text" value="{{ old('name') }}" name="name">
                                    <span class="text-danger">@error('name'){{ $message }}@enderror</span>
                                 </div>
                                 <div class="input-block">
                                    <label>Mobile No <span class="login-danger">*</span></label>
                                    <input required class="form-control" type="text" value="{{ old('mobile') }}" name="mobile">
                                    <span class="text-danger">@error('mobile'){{ $message }}@enderror</span>
                                 </div>
                                 <div class="input-block">
                                    <label>Email <span class="login-danger">*</span></label>
                                    <input required class="form-control" type="email" value="{{ old('email') }}" name="email">
