...
<div class="page-wrapper">
    ...
    <li class="breadcrumb-item active">Send Doctor Notification</li>
    </ul>
    </div>
    </div>
    </div>
...
@endif
    ...
    <div class="card-body p-4">
        ...
        <form method="POST" action="{{ route('admin.notification.smt_notification_astrologer')}}" enctype="multipart/form-data">
            @csrf
          <div class="row">
          <div class="col-md-6">
           <div class="mb-3">
          ...
          <input type="text" name="mobile" id="mid" hidden>
            <label>Doctor</label>
            <input type="text" autocomplete="off"  id="search-box" name="name" value="" class="form-control"  placeholder="Doctor Name.." required>
