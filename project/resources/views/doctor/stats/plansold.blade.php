                   ...
                   <div class="page-table-header mb-2">
                     <div class="row align-items-center">
                       ...
                       <div class="col-auto text-end float-end ms-auto download-grp">
                            ...
                            <div class="add-group">
                              <a href="{{ route('admin.appoint.plansold') }}" class="btn btn-primary doctor-refresh ms-2"><img src="{{asset('content/admin')}}/img/icons/re-fresh.svg" alt></a>
                           </div>
                        </div>
                     </div>
                  </div>
                   ...
                   <div class="table-responsive">
                      <table class="table border-0 custom-table comman-table datatable mb-0">
                         ...
                         <tbody>
                            ...
                            <tr>
                               <td class="profile-image sorting_1">{{$a['pack_name']}}</td>
                               <td>{{$a['total_sales']}}</td>
...
<script>
    $(document).ready(function () {
        $('#dateFilter1').change(function () {
            ...
            if (selectedValue) {
                window.location.href = "{{ route('admin.appoint.plansold') }}?date_filter=" + selectedValue;
            }
        });
    });
</script>
