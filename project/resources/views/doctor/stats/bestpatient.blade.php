                   ...
                   <div class="table-responsive">
                      <table class="table border-0 custom-table comman-table datatable mb-0">
                         ...
                         <tbody>
                            ...
                            <tr>
                               <td class="profile-image sorting_1"><img width="28" height="28" src="{{asset('content/user').'/'.$a->userdetail->image}}" class="rounded-circle m-r-5" alt=""> {{$a->userdetail->name.' '.$a->userdetail->last_name}}</td>
