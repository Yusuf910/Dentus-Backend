                     ...
                     <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <input name="address" id="firstName1" type="text" class="form-control" placeholder="address" />
                           </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                           <div class="input-block local-forms">
                              ...
                              <option value="">Select</option>
                                 @foreach ($State as $tt)
                                   <option value="{{$tt->id}}">{{$tt->state_title}}</option>
                                 @endforeach
                               </select>
                           </div>
                        </div>
